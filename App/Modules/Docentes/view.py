...
from App.Modules.Formularios.forms import formularioDocentes
from App.models import Docente
from django.urls import reverse_lazy
modelo = Docente
formulario = formularioDocentes
entidad = 'Docentes'
main = 'main.html'
...
class listarDocentes(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['encabezado'] = ['nombre','apellido','e-mail','dirección','celular','fotografía']
        context['items'] = modelo.objects.all()
        context['title'] = f'{entidad}' 
        context['listado'] = f'Listado de {entidad}' 
        return context
    
class addDocentes(CreateView):
    model = modelo
...
class editDocentes(UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        return context
class deleteDocentes(DeleteView):
    model = modelo
    form_class = formulario
    template_name = main
    success_url = url
