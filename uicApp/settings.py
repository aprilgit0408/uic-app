"""
Django settings for uicApp project.
...
SECRET_KEY = 'django-insecure-jzq@8p9!8ifi2ptbk_02zvz=0km&6on28tvi0f(2rz=r2hfjaz'
...
ROOT_URLCONF = 'uicApp.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['App/Modules', 'App/Templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'uicApp.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'erickjosa@hotmail.com'
EMAIL_HOST_PASSWORD = '@butterflies'
